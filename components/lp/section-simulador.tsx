                                ...
                                {isSubmitted ? (
                                    ...
                                    >
                                        ...
                                        <div className="space-y-2">
                                            <h3 className="text-xl font-extrabold text-slate-900 tracking-tight">Venacor
                                                ...
                                                <div className="flex flex-col gap-4">
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <motion.button
                                                            ...
                                                            className={`py-4 px-5 rounded-2xl border text-center font-bold text-sm cursor-pointer transition-all duration-200 ${planType === 'saude'
                                                        ...
                                                        <motion.button
                                                            ...
                                                            className={`py-4 px-5 rounded-2xl border text-center font-bold text-sm cursor-pointer transition-all duration-200 ${planType === 'odonto'
                                                                    ? 'border-[#3b2dff] bg-[#3b2dff]/5 text-slate-800'
                                                                    : 'border-slate-100 hover:border-[#3b2dff]/30 bg-slate-50/50 text-slate-700'
                                                                }`}
                                                        >
                                                    ...
                                                    <motion.button
                                                        ...
                                                        className={`w-full py-4.5 rounded-2xl border text-center font-bold text-sm cursor-pointer transition-all duration-200 ${planType === 'ambos'
                                                                ? 'border-[#3b2dff] bg-[#3b2dff]/5 text-slate-800'
                                                                : 'border-slate-100 hover:border-[#3b2dff]/30 bg-slate-50/50 text-slate-700'
                                                            }`}
                                                    >
                                            ...
                                            >
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                    <motion.button
                                                        ...
                                                        className={`p-5 rounded-2xl border text-left cursor-pointer transition-all duration-200 flex flex-col gap-2.5 ${profileType === 'individual'
                                                    ...
                                                    <motion.button
                                                        ...
                                                        className={`p-5 rounded-2xl border text-left cursor-pointer transition-all duration-200 flex flex-col gap-2.5 ${profileType === 'corporate'
                                                                ? 'border-[#3b2dff] bg-[#3b2dff]/5 text-slate-850'
                                                                : 'border-slate-100 hover:border-[#3b2dff]/30 bg-slate-50/50 text-slate-700'
                                                            }`}
                                                    >
                                            ...
                                            >
                                                ...
                                                <div className="space-y-4 max-h-[220px] overflow-y-auto pr-1">
                                                    <div className="relative flex flex-col mt-4">
                                                        ...
                                                        <label
                                                            htmlFor="titularAge"
                                                            className="absolute left-4 top-1.5 text-[9px] font-black uppercase tracking-wider text-slate-400 transition-all pointer-events-none peer-placeholder-shown:text-xs peer-placeholder-shown:top-4 peer-placeholder-shown:font-bold peer-focus:top-1.5 peer-focus:text-[9px] peer-focus:font-black peer-focus:text-[#3b2dff]"
                                                        >
                                                            Sua Idade
                                                        </label>
                                                    </div>
                                                            ...
                                                            >
                                                                <div className="relative flex flex-col mt-4">
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className="absolute right-4 top-4 text-slate-400 hover:text-rose-500 cursor-pointer z-10"
                                                                    >
                                            ...
                                            >
                                                ...
                                                <form onSubmit={handleSubmit} className="space-y-4">
                                                    ...
                                                    <div className="relative flex flex-col mt-4">
                                                        ...
                                                        <label
                                                            htmlFor="whatsapp"
                                                            className={`absolute left-10 top-1.5 text-[9px] font-black uppercase tracking-wider transition-all pointer-events-none peer-placeholder-shown:text-xs peer-placeholder-shown:top-4 peer-placeholder-shown:font-bold peer-focus:top-1.5 peer-focus:text-[9px] peer-focus:font-black ${isPhoneValid
                                                                    ? 'text-emerald-500 peer-focus:text-emerald-600'
                                                                    : 'text-slate-400 peer-focus:text-[#3b2dff]'
                                                                }`}
                                                        >
                                                            WhatsApp com DDD
                                                        </label>
