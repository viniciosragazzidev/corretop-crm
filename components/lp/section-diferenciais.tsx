                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="lg:col-span-4 flex flex-col items-start gap-6 text-left w-full"
                            >
                                ...
                                <ul className="flex flex-col gap-3.5 w-full">
                                    {currentTab.checklist.map((item, idx) => (
                                        <motion.li
                                            ...
                                            animate={{ opacity: 1, x: 0 }}
                                            transition={{ delay: idx * 0.1 + 0.2, type: 'spring', stiffness: 180, damping: 20 }}
                                            className="flex items-start gap-2.5 text-xs sm:text-sm text-slate-600 font-normal leading-normal"
                                        >
                            ...
                            <motion.div
                                ...
                                className="lg:col-span-4 flex flex-col gap-4 w-full relative"
                            >
                                {currentTab.cards.map((card, idx) => (
                                    <motion.div
                                        ...
                                        initial={{ opacity: 0, y: 15 }}
                                        animate={{ opacity: 1, y: 0 }}
                                        transition={{ delay: idx * 0.08 + 0.25, type: 'spring', stiffness: 200, damping: 22 }}
                                    ...
                                    >
                                        <div className="flex justify-between items-center w-full">
                                            ...
                                            {card.statusBadge && (
                                                <span className={`px-2.5 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider ${card.statusType === 'success'
                                        ...
                                        {card.hasProgress && (
                                            <div className="w-full h-1 bg-slate-200 rounded-full overflow-hidden mt-1">
                                                <motion.div
                                                    ...
                                                    className="h-full bg-[#3b2dff] rounded-full"
                                                />
                                            </div>
                                        )}
                                    </motion.div>
