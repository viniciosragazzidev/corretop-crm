  ...
  return (
    <div className="p-8 lg:p-12 min-h-full flex flex-col items-start gap-4 text-left select-none">
      ...
      >
        ...
        <h2 className="text-2xl lg:text-3xl font-black text-slate-900 tracking-tight">Leeds</h2>
        <p className="text-slate-500 text-xs sm:text-sm font-light leading-relaxed">
          Esta é a página de gerenciamento de contatos do CRM. Em breve você poderá visualizar, filtrar e organizar o funil comercial nesta seção.
        </p>
      </motion.div>
    </div>
  );
